...
if {[file isfile img_filter.autotvin.dat]} {
	file delete -force img_filter.autotvin.dat
}

if {[file isfile img_filter.autotvout.dat]} {
	file delete -force img_filter.autotvout.dat
}
