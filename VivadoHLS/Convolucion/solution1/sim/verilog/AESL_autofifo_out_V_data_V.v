...
module AESL_autofifo_out_V_data_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.img_filter.autotvin_out_V_data_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.img_filter.autotvout_out_V_data_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 24;
parameter ADDR_WIDTH = 32'd 20;
parameter DEPTH = 32'd 307200;
