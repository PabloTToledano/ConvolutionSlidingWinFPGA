...
module AESL_autofifo_out_V_dest_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.img_filter.autotvin_out_V_dest_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.img_filter.autotvout_out_V_dest_V.dat";
