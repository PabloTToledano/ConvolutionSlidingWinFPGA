...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "img_filter.autotvin.dat"
	set constFileTvOut       "img_filter.autotvout.dat"
	set constFileHdlTvIn     "img_filter.autohdltvin.dat"
	set constFileHdlTvOut    "img_filter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
